    ...
    return (
        <Fragment>
            ...
            {/* <div className='h-[50vh] flex flex-col gap-5 items-center justify-center'>
                ...
                <button onClick={getProductImage} className='bg-orange-400 p-3 hover:bg-transparent hover:outline-dashed'>get product image</button>
            </div> */}
            <p className='text-center'>YOU ARE NOT SUPPOSED TO BE HERE
            </p>
        </Fragment>
    )
}
